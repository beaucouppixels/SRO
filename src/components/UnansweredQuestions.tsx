...
const questions = [
  ...
  },
  {
    ...
    context: 'Students, parents, faculty, the principal, and 4,800+ petition signers all supported the SRO. About 11 students and 20 adults spoke in favor at the May 11 meeting. No one spoke against. The board voted against every constituency that testified.',
  },
  {
